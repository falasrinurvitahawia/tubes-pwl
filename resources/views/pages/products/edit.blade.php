                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group"  >
                            <label for="name" class="form-label">Id Pemesanan</label>
                        ...
                        <div class="form-group"  >
                            <label for="description" class="form-label">Nama Pemesan</label>
                        ...
                        <div class="form-group">
                            <label for="sku" class="form-label">Tanggal Pemesan</label>
                        ...
                        <div class="form-group">
                            <label for="price" class="form-label">Jumlah Tiket</label>
